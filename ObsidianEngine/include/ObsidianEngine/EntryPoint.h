...
int main()
{
    ...
    std::cout << (v.swizzle<"yy">() == v10.swizzle<"yy">()) << std::endl;
    ...
    auto r3 = q1 * v3.cast<float>();
    auto r4 = q2.cast<float>() * v3.cast<float>();
    ...
    Matrix3x4 m4 = Matrix3x4::identity();
